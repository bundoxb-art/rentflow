  ...
  return (
    <div className="min-h-screen bg-[#0d1117] flex items-center justify-center px-4 font-sans">
      <div className="w-full max-w-md text-center">
        ...
        <div className="bg-[#111827] border border-yellow-400/20 rounded-2xl p-8">
          <div className="text-6xl mb-4">⏳</div>
          <h1 className="text-2xl font-extrabold mb-3">Account Pending Approval</h1>
          <p className="text-gray-400 text-sm mb-6">
            Your landlord account is being reviewed by our team. 
