  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white font-sans flex">
      <aside className="w-60 bg-[#111827] border-r border-white/5 flex flex-col py-6 flex-shrink-0">
        ...
        <nav className="flex flex-col gap-1 px-2">
          {[
            ...
            { icon: "🔔", label: "Reminders", href: "/dashboard/reminders", active: true },
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-8">
        ...
        <h1 className="text-2xl font-extrabold mb-2">Reminders</h1>
        <p className="text-gray-500 mb-6">Automated SMS reminders to tenants coming soon!</p>
        <div className="bg-[#111827] border border-[#f0b429]/20 rounded-2xl p-6 max-w-md">
          ...
          <p className="text-gray-400 text-sm">Automatic reminders will be sent to unpaid tenants 5 days before and after due date via SMS using Africa's Talking API.</p>
        </div>
      </main>
    </div>
  );
